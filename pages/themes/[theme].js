...
export async function getServerSideProps({ params }) {
  ...
  const { data: works } = await supabase
    ...
    `)
    .contains('themes', [decodeURIComponent(theme)])
    .eq('is_public', true)
...
export default function ThemePage({ works, theme }) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold">'{theme}' 테마의 작품들</h1>
                  ...
                  {work.themes
                    ...
                    .map(t => (
                      <Link
                        ...
                        className="inline-block text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded mr-2 mb-1 hover:bg-gray-200"
                      >
                        {t}
                      </Link>
                    ))}
